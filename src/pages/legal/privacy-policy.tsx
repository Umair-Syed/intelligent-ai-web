export default function PrivacyPolicy() {
  return (
    <section className="legal-section mt-4 px-24 pb-10 pt-4">
      ...
      <h2 className="topic">5. Data Security</h2>
      ...
      <h2 className="topic">9. Contact Us</h2>
      <p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:syedumairandrabi66@gmail.com">syedumairandrabi66@gmail.com</a>.</p>
    </section>
  );
}